...
REPO_URL = 'https://github.com/KludgeKML/kludge-tddtest'
SITES_FOLDER = '/home/pi/sites'
...
def _creat_directory_structure_if_necessary(site_name):
...
def _update_static_filder(source_folder):
